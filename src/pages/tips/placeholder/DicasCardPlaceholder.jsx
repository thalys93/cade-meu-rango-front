...
function DicasCardPlaceholder() {
    const { isDarkMode } = React.useContext(DarkModeContext);

    return (
    <Card className={isDarkMode? 'bg-dark animate__animated animate__fadeIn' : 'bg-light'} style={{ width: '17rem' }}>      
      <Card.Body>
        <Card.Title className={isDarkMode? 'DarkTxt' : 'txt'}>
            <Placeholder>
                <Placeholder xs={2} className={isDarkMode ? 'bg-body' : ''} style={{width: 150 , height: 5}}/>
            </Placeholder>            
             <br/>
...
export default DicasCardPlaceholder;